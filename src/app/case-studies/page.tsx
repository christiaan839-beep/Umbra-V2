...
const CASES = [
  {
    ...
    role: "Founder & CEO",
    industry: "SaaS",
    challenge: "TechVentures was spending $15k/mo on a 4-person marketing team — copywriter, media buyer, designer, and project manager. Results were inconsistent. Some months ROAS hit 3x, others dropped below 1x. They couldn't figure out what was working.",
    solution: "Deployed UMBRA Ghost Mode with a 2.5x ROAS kill threshold. God-Brain started cataloging every winning pattern. Swarm Critic debated every piece of ad copy before deployment.",
    results: [
      { label: "Monthly Revenue", before: "$38k", after: "$124k", metric: "+226%" },
      { label: "ROAS", before: "1.8x avg", after: "4.7x avg", metric: "+161%" },
      { label: "Marketing Cost", before: "$15k/mo", after: "$997/mo", metric: "-93%" },
  ...
  },
  {
    ...
    challenge: "Apex Fitness was running Facebook and Instagram ads manually. Sarah was spending 20+ hours per week managing campaigns, killing losers, and writing new variations. Growth had plateaued at $40k/mo.",
    ...
    results: [
      { label: "Monthly Revenue", before: "$40k", after: "$67k", metric: "+68%" },
    ...
    quote: "Ghost Mode ran our ads for 3 months straight. We stopped checking. When we looked, ROAS was 4.7x.",
    timeline: "60 days",
    color: "#00ff88",
  },
  {
    ...
    challenge: "David was running a small agency with 6 clients. He was doing everything himself — ads, content, reporting. He couldn't take on more clients without hiring, and hiring would eat his margins. Revenue was stuck at $18k/mo.",
    solution: "Bought the UMBRA Franchise license. Rebranded it as 'ForgeAI' and sold it to his existing clients at $5k/mo each. Then prospected for new clients using the Lead Scoring and AI Playground to demo the platform live.",
    results: [
      { label: "Monthly Revenue", before: "$18k", after: "$60k", metric: "+233%" },
      { label: "Client Count", before: "6", after: "12", metric: "+100%" },
      { label: "Revenue per Client", before: "$3k", after: "$5k", metric: "+67%" },
      { label: "Employees Needed", before: "Considering hiring", after: "0", metric: "Zero hires" },
    ],
    quote: "I bought the Franchise license. Now I sell UMBRA to my clients at $5k/mo each. I have 12 clients. Do the math.",
    timeline: "45 days",
    color: "#ff3366",
  },
];
