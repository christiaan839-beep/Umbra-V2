      ...
      <main className="pt-40 pb-20 px-6 relative overflow-hidden flex flex-col items-center min-h-[90vh] justify-center">
        ...
        <motion.div initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.7, ease: [0.16, 1, 0.3, 1] }} className="relative z-10 w-full max-w-5xl mx-auto text-center">
          ...
          <div className="flex flex-wrap items-center justify-center gap-6 mb-20 max-w-4xl mx-auto">
           ...
           {/* Social Proof — Operational Evidence */}
          <div className="w-full max-w-5xl mx-auto mb-20 mt-10">
              <div className="text-center mb-10">
                 <h2 className="text-3xl md:text-5xl font-bold text-transparent bg-clip-text bg-gradient-to-b from-white to-[#10B981] serif-text mb-4">Proven In Production</h2>
                 <p className="text-neutral-500 max-w-2xl mx-auto text-sm">
                   These numbers are generated by real agents executing on real infrastructure, 24/7.
                 </p>
              </div>
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-12">
                {[
                  { end: 47000, suffix: "+", label: "Words Generated", prefix: "" },
                  { end: 2400, suffix: "+", label: "Leads Captured", prefix: "" },
                  { end: 340, suffix: "ms", label: "Avg Response Time", prefix: "" },
                  { end: 99, suffix: ".9%", label: "Uptime SLA", prefix: "" },
                ].map((stat, i) => (
                  <motion.div key={i} initial={{ opacity: 0, y: 15 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ delay: i * 0.1 }}
                    ...
                    <div className="text-[10px] uppercase tracking-[0.2em] text-[#10B981] mt-2 font-bold">{stat.label}</div>
                  </motion.div>
                ))}
              </div>
             <AIDemoShowcase />
